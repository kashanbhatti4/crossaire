      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
          ...
          <div className="flex flex-col gap-4">
            <LocalFAQItem question="What are your core services?">
            ...
            <LocalFAQItem question="Are your services compliant with NFPA 96 and local fire codes?">
            ...
            <LocalFAQItem question="Can you service my kitchen after business hours?">
            ...
            <LocalFAQItem question="What areas do you service?">
            ...
            <LocalFAQItem question="Do you repair exhaust fans?">
            ...
            <LocalFAQItem question="Do you specialize in water wash hoods?">
          ...
          {/* Right Column */}
          <div className="flex flex-col gap-4">
            <LocalFAQItem question="How often should I have my commercial kitchen hood cleaned?">
            ...
            <LocalFAQItem question="Do you provide before-and-after photos?">
            ...
            <LocalFAQItem question="Do you offer maintenance programs or recurring service plans?">
            ...
            <LocalFAQItem question="What’s included in a typical hood cleaning service?">
            ...
            <LocalFAQItem question="Do you install exhaust fans?">
            ...
            <LocalFAQItem question="Do you perform inspections?">
